...
PLOTS_SENSE_ANALYSIS_CORR_DIR = './results/COHA/plots/hidden1-maskedN/sense_analysis_all10nn/corr'
PLOTS_SENSE_ANALYSIS_DIFF_DIR = './results/COHA/plots/hidden1-maskedN/sense_analysis_all10nn/diff'
