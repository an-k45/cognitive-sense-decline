...
COHA_SENSE_ANALYSIS_SUM_DIR = './data/COHA/hidden1-maskedN/sense_analysis_summary_all10nn'
PLOTS_SENSE_ANALYSIS_SUM_DIR = './results/COHA/plots/hidden1-maskedN/sense_analysis_all10nn/summary'
