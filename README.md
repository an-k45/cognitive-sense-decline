This repository contains code and data for "Cognitive Factors in Word Sense Decline".

## Code
The code to run this project is organized in 3 portions, all under /src.
